...
def main():
    parser = argparse.ArgumentParser(description="Weatherman - A command-line tool for weather data analysis.")
    ...
    if not os.path.exists(args.folder_path):
        print("Error: The folder path '{}' does not exist.".format(args.folder_path))
        return
